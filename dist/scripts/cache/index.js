...
const caches_1 = __importDefault(__webpack_require__(494));
 ...
 */
function safeImportRun(moduleName, inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        // We assume the default export of the module is always the runner function.
        const { default: runModule } = yield inputs_1.applyInputs({ [constants_1.EnvVariable.GitHubEventName]: '' }, () => Promise.resolve().then(() => __importStar(require(moduleName))));
        return yield inputs_1.applyInputs(inputs, runModule);
    });
}
exports.actions = {
    restore(inputs) {
